...
\AtBeginDocument{  % セクション名から「第○章」を除外
...
\usepackage[dvipdfmx,colorlinks=true,linkcolor=black,citecolor=black,urlcolor=blue]{hyperref}

% 参考文献の引用を上付き文字に設定
\makeatletter
\renewcommand\@cite[2]{$^{\mbox{\scriptsize{[#1\if@tempswa , #2\fi]}}}$}
\makeatother
